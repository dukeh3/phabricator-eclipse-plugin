...
public class ProjectTasksView extends ViewPart {
	...
	class ViewContentProvider implements ITreeContentProvider {
		...
		public Object[] getElements(Object parent) {
			...
			System.out.println("ProjectTasksView.ViewContentProvider.getElements()" + parent);
		...
		public Object getParent(Object child) {
			...
			System.out.println("ProjectTasksView.ViewContentProvider.getParent()" + child);
		...
		public Object[] getChildren(Object parent) {
			...
			System.out.println("ProjectTasksView.ViewContentProvider.getChildren()" + parent);
	...
	// System.out.println("ProjectTasksView.ViewLabelProvider.getColumnText()" + obj);
	//
	// return getText(obj);
	// }
	//
	// public Image getColumnImage(Object obj, int index) {
	// System.out.println("ProjectTasksView.ViewLabelProvider.getColumnImage()" +
	// obj);
	//
	// return getImage(obj);
	// }
	...
	//
	// System.out.println("ProjectTasksView.ViewLabelProvider.getText()" + obj);
	//
	// return obj.toString();
	// }
	//
	...
	class TableLabelProvider implements ITableLabelProvider {
		...
		public Image getColumnImage(Object obj, int index) {
			System.out.println("ProjectTasksView.ViewLabelProvider.getColumnImage()" + obj);
